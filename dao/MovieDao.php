    ...
    class MovieDao implements MovieInterface {
        ...
        public function getLatestMovies() {
            ...
            if($stmt->rowCount() > 0) {
                ...
                foreach($moviesArray as $valuesMoviesArray) {
                    $movies[] = $this->buildMovie($valuesMoviesArray);
                }
        ...
        public function create(Movie $movie) {
            ...
            $this->message->defineMessage("Filme adicionado com sucesso! ", "success", "index.php");
        }
        ...
        public function update(Movie $movie) {
            ...
            //Mensagem de sucesso remove filme
            $this->message->defineMessage("Filme editado com sucesso! ", "success", "dashboard.php");
        ...
        public function destroy($id) {
            ...
            //Mensagem de sucesso remove filme
            $this->message->defineMessage("Filme deletado com sucesso! ", "success", "dashboard.php");
        }
